...
@section('meta_title', "Sản phẩm combo")
@section('meta_keyword', "Sản phẩm combo")
@section('meta_description', "Sản phẩm combo")
    ...
    <div class="container custom_container">
        <div class="inner_menu float_left">
            <ul>
                ...
                <li class="active"><a href="#"> <span><i class="fas fa-angle-right"></i></span> Combo </a></li>
            </ul>
        </div>
    </div>
</div>
                            ...
                            <div class="container">
                                <div id="sidebar-filter" class="d-block d-sm-block d-md-block d-lg-none d-xl-none">
                                    ...
                                    <div id='cssmenu-filter'>
                                        @include('components.sidebar', ["sidebar_type" => "mobile", "is_combo" => true])
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="pc-sidebar">
                            @include('components.sidebar', ["sidebar_type" => "pc", "is_combo" => true])
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    @foreach($products as  $product)
                                        <div class="col-lg-4 col-md-6 col-6 w-490-full">
                                            @include('components.item-product', ["product" => $product, "is_combo" => true])
                                        </div>
                                    @endforeach
                                </div>
                            </div>
