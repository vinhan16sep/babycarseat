                            ...
                            <a href="{{ route("san-pham", ['category_slug' => $_product->categoryId->slug, 'slug' => $_product->slug]) }}">
                                ...
                                <div class="price">
                                    @if(!empty($_product->discount_value))
                                        Giá gốc <span class="sub-price">{{ numberFormat($_product->price) }}</span> VNĐ | <span style="font-weight: bold;color: #d20046">{{ numberFormat($_product->discount_value) }} VNĐ</span>
                                    @else
