                ...
                <div class="card">
                    <div class="card-body offset-1 col-lg-10">
                        <div class="basic-form">
                            <form role="form" method="POST" action="{{ route('update-region', ['id' => $object->id]) }}">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group{{ $errors->has('country_id') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="country_id" value="{{ old('country_id', $object->country_id) }}" >
                                        <option></option>
                                ...
                                <a type="button" href="{{ route('list-region') }}" class="btn btn-default btn-outline"><i class="ti-back-left icon-black"></i>&nbsp;&nbsp;Quay lại</a>
