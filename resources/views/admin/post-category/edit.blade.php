                ...
                <div class="card">
                    <div class="card-body offset-1 col-lg-10">
                        <div class="basic-form">
                            <form role="form" method="POST" action="{{ route('update-post-category', ['id' => $object->id]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="form-group{{ $errors->has('parent_id') ? ' has-error' : '' }}">
                                    ...
                                    <select name="parent_id" class="form-control">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" {{ old('parent_id', $object->parent_id) == $category->id ? 'selected' : '' }}>
