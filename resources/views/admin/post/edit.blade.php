                ...
                <div class="card">
                    <div class="card-body offset-1 col-lg-10">
                        <div class="basic-form">
                            <form role="form" method="POST" action="{{ route('update-post', ['id' => $object->id, 'callback' => $callback]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group{{ $errors->has('position') ? ' has-error' : '' }}">
                                    <label>Vị trí</label>
                                    <input type="text" name="position" value="{{ old('position', $object->position) }}" class="form-control" maxlength="255">
