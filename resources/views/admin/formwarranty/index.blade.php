        ...
        <div class="col-lg-8 p-r-0 title-margin-right">
            <div class="page-header">
                <div class="page-title">
                    <h1>Danh sách đăng Ký Chương trình bảo hành vàng 12 năm Babyro</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('list-formwarranty') }}" class="my-search-form">
                            <div class="col-md-12">
                                <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <a type="button" href="{{ route('list-formwarranty') }}" class="btn btn-default"></i>&nbsp;&nbsp;RESET</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                                    ...
                                    @foreach ($forms as $key => $item)
                                        <tr>
                                            ...
                                            <td class="color-primary">
                                                <a type="button" href="{{ route('show-formwarranty', ['id' => $item->id]) }}" class="btn btn-primary btn-flat my-list-btn"><i class="ti-eye icon-white"></i></a>
                                                <button type="button" class="btn btn-danger btn-flat m-l-5 my-list-btn" onclick="deleteRow('{{ $item->id }}', '/formwarranty/delete-row')"><i class="ti-trash"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
