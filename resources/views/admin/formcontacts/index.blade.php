        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('list-contacts') }}" class="my-search-form">
                            <div class="col-md-12">
                                <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <a type="button" href="{{ route('list-contacts') }}" class="btn btn-default"></i>&nbsp;&nbsp;RESET</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="table my-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="w-20 center">Lời nhắn</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($forms as $key => $item)
                                        <tr>
                                            ...
                                            <td class="color-primary">
                                                <a type="button" href="{{ route('show-contacts', ['id' => $item->id]) }}" class="btn btn-primary btn-flat my-list-btn"><i class="ti-eye icon-white"></i></a>
                                                <button type="button" class="btn btn-danger btn-flat m-l-5 my-list-btn" onclick="deleteRow('{{ $item->id }}', '/contacts/delete-row')"><i class="ti-trash"></i></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
