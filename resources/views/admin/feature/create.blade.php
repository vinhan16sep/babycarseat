                ...
                <div class="card">
                    <div class="card-body offset-1 col-lg-10">
                        <div class="basic-form">
                            <form role="form" method="POST" action="{{ route('store-feature') }}" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="sort_content" class="form-control" id="txtareaSortContent">{{ old('sort_content') }}</textarea>
