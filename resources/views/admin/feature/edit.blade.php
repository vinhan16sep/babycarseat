                ...
                <div class="card">
                    <div class="card-body offset-1 col-lg-10">
                        <div class="basic-form">
                            <form role="form" method="POST" action="{{ route('update-feature', ['id' => $object->id, 'callback' => $callback]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group{{ $errors->has('label') ? ' has-error' : '' }}">
                                    <label>Nhãn </label>
                                    <input type="text" name="label" value="{{ old('label',$object->label) }}" class="form-control" id="inputLabel" maxlength="255">
                                    @if ($errors->has('label'))
                                ...
                                <div class="form-group">
                                    <label for="sort_content" class="form-label">Nội dung tóm tắt</label>
                                    <textarea name="sort_content" class="form-control" id="txtareaSortContent">{{ old('sort_content',$object->sort_content) }}</textarea>
                                    @if ($errors->has('sort_content'))
                                        <span style="color:red;">{{ $errors->first('sort_content') }}</span>
                                    @endif
                                </div>
                                ...
                                <a type="button" href="{{ route('list-feature') }}" class="btn btn-default btn-outline"><i class="ti-back-left icon-black"></i>&nbsp;&nbsp;Quay lại</a>
