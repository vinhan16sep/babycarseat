        ...
        <div class="col-xl-6 d-none d-xl-block">
            <nav class="box-navigation text-center">
                <ul class="box-nav-ul d-flex align-items-center justify-content-center">
                    ...
                    <li class="menu-item"><a href="{{ url('san-pham') }}" class="item-link">Sản phẩm</a></li>
                    <li class="menu-item"><a href="#" class="item-link">Blogs</a></li>
                    <li class="menu-item"><a href="#" class="item-link">Kiến thức</a></li>
