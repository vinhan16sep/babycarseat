                                    ...
                                    <div class="tf-cart-checkbox">
                                        ...
                                        <label class="text-caption-1" for="footer-Form_agree">
                                            By clicking subcribe, you agree to the <a class="fw-6 link"
                                                                                      href="term-of-use.html">Terms of
                                                Service</a> and <a class="fw-6 link" href="#">Privacy Policy</a>.
                                        </label>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="mb-body">
            <div class="mb-content-top">
                ...
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    ...
                    <li class="nav-mb-item">
                        <a href="{{ route('product-list') }}" class="mb-menu-link">Products</a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="{{ route('news') }}" class="mb-menu-link">Blogs</a>
                    </li>
                    <li class="nav-mb-item">
                        <a href="{{ route('category-detail-knowledge') }}" class="mb-menu-link">Knowledge</a>
                    </li>
                    <li class="nav-mb-item">
