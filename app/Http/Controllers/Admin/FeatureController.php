...
class FeatureController extends AdminController
{
    ...
    public function index() {
        $list = Feature::orderBy('updated_at', 'desc')->paginate(10);
        return view('admin/feature/index', compact('list'));
    }
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            DB::rollBack();
            return redirect()->route('create-feature')->with('error', $e->getMessage()); 
        }
    }
    ...
    public function edit($id) {
        ...
        if ($object == null || $object->count() == 0) {
            return redirect()->route('list-feature')->with('error', Config::get('constants.MESSAGE.DATA_NOT_FOUND'));
        }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            if ($object->save()) {
                ...
                return redirect()->route('list-feature', $params)->with('success', Config::get('constants.MESSAGE.UPDATE_SUCCEEDED'));
            }
            DB::rollBack();
            return redirect()->route('edit-feature', [
                'id' => $id, 
    ...
    public function delete(Request $request) {
        ...
        try {
            ...
            $object = Feature::find($request['id']);
            // If object not found
            if ($object == null || $object->count() == 0) {
                return response()->json(['status' => 'error','msg' => Config::get('constants.MESSAGE.DATA_NOT_FOUND')], 404);
            }
