...
class NewsController extends AdminController
{
    ...
    public function index() {
        $list = News::orderBy('updated_at', 'desc')->paginate(10);
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            if ($model->save()) {
                ...
                if ($model->save()) {
                    DB::commit();
                    return redirect()->route('list-news')->with('success', Config::get('constants.MESSAGE.CREATE_SUCCEEDED'));
                }
                DB::rollBack();
                return redirect()->route('create-news')->with('error', Config::get('constants.MESSAGE.SOMETHING_ERROR'));
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            if ($object->save()) {
                ...
                return redirect()->route('list-news', $params)->with('success', Config::get('constants.MESSAGE.UPDATE_SUCCEEDED'));
            }
            DB::rollBack();
            return redirect()->route('edit-news', [
                'id' => $id, 
